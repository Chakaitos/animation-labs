      ...
      <div className="container relative mx-auto px-4 py-12 md:py-16">
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://x.com/AnimationLabsAI"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/AnimationLabsAI"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.youtube.com/@AnimationLabsAI"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/animation-labs-ai"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.tiktok.com/@animationlabsai"
              target="_blank"
              rel="noopener noreferrer"
