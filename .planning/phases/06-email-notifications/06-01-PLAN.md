...
must_haves:
  truths:
    - "Email templates render with AnimateLabs branding"
...
1. Create `emails/_components/EmailLayout.tsx`:
   - Shared layout with AnimateLabs branding
   - Logo header (use absolute URL: https://animatelabs.com/logo.svg for email clients)
