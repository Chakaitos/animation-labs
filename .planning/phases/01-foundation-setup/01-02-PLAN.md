...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <h1 className="text-4xl font-bold mb-4">Animation Labs</h1>
...
Visit http://localhost:3000 - page shows "Animation Labs" heading.
  </verify>
  <done>
...
4. Homepage loads with "Animation Labs" text
