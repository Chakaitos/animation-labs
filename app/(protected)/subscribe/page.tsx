      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {(Object.entries(PLANS) as [PlanId, typeof PLANS.starter][]).map(([planId, plan]) => {
            ...
            const currentPlanCredits = currentPlan ? PLANS[currentPlan].credits : 0
            const isUpgrade = hasActiveSubscription && plan.credits > currentPlanCredits
            const isDowngrade = hasActiveSubscription && plan.credits < currentPlanCredits
